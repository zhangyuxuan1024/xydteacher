 ...
 */
public class FragmentClassAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public FragmentClassAdapter(Context context, List<Object> list) {
        this.context = context;
        this.list = list;
    }
    ...
    public void toActivity(String title, GradeReport gr) {
        Intent intent = new Intent(context, StudentTestActivity.class);
        Student student = new Student();
        student.setSchoolId(gr.getSchoolId());
        student.setMeId(gr.getMeId());
        student.setSeId(gr.getSeId());
        student.setStudentId(gr.getStudentId());
        student.setName(gr.getName());
        student.setScore(gr.getScore());
